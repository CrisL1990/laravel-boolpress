...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    cutText: function cutText(text, len) {
      if (text.length > len) {
      ...
      _c(
        ...
        [
          ...
          _c("p", { staticClass: "card-text" }, [
            _vm._v(_vm._s(_vm.cutText(_vm.content, _vm.textLen))),
          ]),
          _vm._v(" "),
          _c(
            "router-link",
            {
              staticClass: "nav-link",
              attrs: {
                to: { name: "single-post", params: { slug: _vm.slug } },
              },
            },
            [_vm._v("Vedi Post")]
          ),
...
var staticRenderFns = [
  function () {
    ...
    return _c("main", [
      ...
      _c("p", [
        _vm._v(
          "Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum obcaecati architecto repellendus nesciunt culpa unde nulla modi quas ipsum ut exercitationem optio, eaque enim illo maiores aspernatur, cumque deserunt totam."
        ),
      ]),
    ])
  },
      ...
      _c(
        ...
        [
          ...
          _vm._l(_vm.errors.message, function (error, index) {
            return _c(
              "p",
              { key: "error_message" + index, staticClass: "invalid-feedback" },
              [_vm._v("\n            " + _vm._s(error) + "\n        ")]
            )
          }),
        ],
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", [_c("h1", [_vm._v("ERRORE 404 PAGINA NON TROVATA")])])
  },
]
render._withStripped = true
...
module.exports = __webpack_require__(/*! /Users/christian/Desktop/Boolean/Esercizi/laravel-boolpress/resources/js/front.js */"./resources/js/front.js");
